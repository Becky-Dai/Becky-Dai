...
I build web and mobile applications that combine full-stack engineering with AI-powered features.  
我热衷于构建融合全栈工程与 AI 能力的 Web 和移动应用。
...
**Database:** Supabase (PostgreSQL) &nbsp;·&nbsp; Neo4j &nbsp;·&nbsp; SQL  
...
| [BaaDo](https://github.com/Becky-Dai/Baa-Do) | Strictly two-player Todo/Habit app — care for a shared lamb and build a cozy meadow together | Next.js · TypeScript · Tailwind CSS |
| [SipSwipe](https://github.com/Becky-Dai/vibecoding) | Swipe-based drink discovery app — real auth, per-user taste profiles, community posts, and sip diary backed by Supabase | Expo · React Native · TypeScript · Supabase |
